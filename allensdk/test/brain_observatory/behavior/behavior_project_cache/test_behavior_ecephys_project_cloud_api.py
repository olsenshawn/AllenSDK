...
from allensdk.brain_observatory.behavior.behavior_project_cache.project_apis.\
    data_io import behavior_ecephys_project_cloud_api as cloudapi  # noqa: E501
from allensdk.brain_observatory.behavior.behavior_project_cache.project_apis.\
        data_io.behavior_ecephys_project_cloud_api \
        import MANIFEST_COMPATIBILITY as VBN_MANIFEST_COMPATIBILITY
...
class MockCache():
    def __init__(self,
        ...
        self.session_table_path = cachedir / "sessions.csv"
        ...
        self._metadata_name_path_map = {
                ...
                "sessions": self.session_table_path,
...
def mock_cache(request, tmpdir):
    ...
    est = request.param.get("sessions")
...
def test_BehaviorEcephysProjectCloudApi(mock_cache, monkeypatch, local):
    mocked_cache, expected = mock_cache
    api = cloudapi.BehaviorEcephysProjectCloudApi(
        mocked_cache,
    ...
    est = est.reset_index()
    est_expected = expected["sessions"]
...
def test_from_local_cache(monkeypatch):
    ...
    mock_manifest.version = VBN_MANIFEST_COMPATIBILITY[0]
    ...
    with monkeypatch.context() as m:
        ...
        try:
            cloudapi.BehaviorEcephysProjectCloudApi.from_local_cache(

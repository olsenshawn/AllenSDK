...
from allensdk.brain_observatory.behavior.behavior_project_cache.project_apis.\
        ...
        import MANIFEST_COMPATIBILITY as VBO_MANIFEST_COMPATIBILITY
...
def s3_cloud_cache_data():
    ...
    min_compat = semver.parse_version_info(VBO_MANIFEST_COMPATIBILITY[0])
    versions = []
...
def vbn_s3_cloud_cache_data():
    ...
    min_compat = semver.parse_version_info(VBN_MANIFEST_COMPATIBILITY[0])
    versions = []
    ...
    buff.seek(0)
    metadata['sessions'] = bytes(buff.read(), 'utf-8')
